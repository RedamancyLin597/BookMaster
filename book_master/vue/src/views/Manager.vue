  ...
  <div>
    ...
    <div style="height: 40px; line-height: 40px; background-color: #05a081; display: flex">
      <div style="width: 200px; padding-left: 20px">
        ...
        <span style="font-size: 16px; color: #eee; margin-left: 10px; font-weight: bold;">图书借阅管理系统</span>
      </div>

      <div style="flex: 1">
        <span style="color: white; font-size: 14px; margin-left: 20px">当前时间： {{ time }}</span>
      </div>
    ...
    <div style="display: flex; min-height: calc(100vh - 40px)">
      ...
      <div :style="{'width': menuWidth }">
        ...
        >
          ...
          <el-menu-item index="/bookBorrow" v-if="user.role === 'USER'">
            <i class="el-icon-document-add"></i>
            <span slot="title">我的借阅</span>
          </el-menu-item>
          <el-menu-item index="/bookBorrow" v-if="user.role === 'ADMIN'">
            <i class="el-icon-document-add"></i>
            <span slot="title">审核借阅</span>
          </el-menu-item>
