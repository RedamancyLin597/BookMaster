...
<!--      <el-card style="width: 50%;" v-show="user.role === 'ADMIN'">-->
<!--        <div id="pie" style="width: 100%; height: 400px"></div>-->
<!--      </el-card>-->

<!--      <el-card style="width: 50%;background-color:#FFFFFF;"  simple v-show="user.role === 'USER'">-->
<!--        <el-steps :active="1"  >-->
